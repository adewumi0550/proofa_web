                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Join the conversation with thousands of AI creators.</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                        ...
                        <div className="space-y-6">
                            <div className="bg-gray-50 dark:bg-white/5 rounded-xl p-6 border border-gray-200 dark:border-white/10">
                                ...
                                <div className="space-y-2">
                                    {['General Discussion', 'Showcase', 'Legal & Licensing', 'Technical Support', 'Feature Requests'].map((cat) => (
                            ...
                            <div className="bg-blue-50 dark:bg-blue-900/10 rounded-xl p-6 border border-blue-100 dark:border-blue-500/20">
                                <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-2 flex items-center gap-2">
                                    <Trophy className="w-4 h-4 text-orange-500" /> Top Contributors
                                </h3>
                        ...
                        <div className="lg:col-span-3 space-y-6">
                            ...
                            <div className="text-center pt-8">
                                <Button variant="ghost" className="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Load More Discussions</Button>
                            </div>
                        </div>
                    </div>
                </div>
