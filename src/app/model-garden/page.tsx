            ...
            <FadeIn>
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-12">
                        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Model Garden</h1>
                        <p className="text-gray-600 dark:text-gray-400">Explore and deploy state-of-the-art AI models with certified workflows.</p>
                    </div>
