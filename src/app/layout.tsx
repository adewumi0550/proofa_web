...
export const metadata: Metadata = {
  title: "Proofa - Certify Your AI Creative Workflows",
              ...
              <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16">
                <div className="flex flex-col md:flex-row justify-between items-start gap-12 lg:gap-8">
                  <div className="space-y-4 max-w-xs">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-lg font-bold text-white">PROOFA</span>
                    </div>
                    <p className="text-sm">
                      The certification layer for AI-generated assets. Monetize your creativity with legal protection.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 lg:gap-16 w-full md:w-auto">
                    <div>
                      ...
                      <ul className="space-y-3 text-sm">
                        <li><a href="/model-garden" className="hover:text-blue-400 transition-colors">Model Garden</a></li>
                        <li><a href="/pricing" className="hover:text-blue-400 transition-colors">Pricing</a></li>
                        <li><a href="/show-off" className="hover:text-blue-400 transition-colors">Showcase</a></li>
                ...
                <div className="mt-12 pt-8 border-t border-white/10 flex flex-col items-center md:flex-row md:justify-between gap-4">
                  <p className="text-xs text-gray-500 order-2 md:order-1">
                    &copy; 2025 Proofa Inc. All rights reserved.
                  </p>
